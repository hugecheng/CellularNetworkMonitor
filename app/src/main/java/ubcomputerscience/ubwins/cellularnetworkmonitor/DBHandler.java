...
public class DBHandler extends SQLiteOpenHelper
{
    ...
    private static final String schema = "CREATE TABLE cellRecords (N_LAT DATA, N_LONG DATA, F_LAT DATA, F_LONG DATA, LOCATION_PROVIDER DATA, TIMESTAMP DATA, NETWORK_TYPE DATA, NETWORK_TYPE2 DATA, NETWORK_PARAM1 DATA, NETWORK_PARAM2 DATA, NETWORK_PARAM3 DATA, NETWORK_PARAM4 DATA, DBM DATA, NETWORK_LEVEL DATA, DATA_STATE DATA, DATA_ACTIVITY DATA, CALL_STATE DATA)";
